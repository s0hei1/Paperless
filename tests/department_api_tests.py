...
async def test_create_department(
    async_client: AsyncClient, fake_department_create_request: dict
):
...
async def test_read_one_department(
    ...
    read_response = await async_client.get(
        Routes.Department.read_one.url, params={"id": department_id}
    )
...
@pytest.mark.asyncio
async def test_read_many_departments(async_client: AsyncClient):
...
async def test_update_department(
    ...
    update_response = await async_client.put(
        Routes.Department.update.url, json=department, params={"id": department["id"]}
    )
...
async def test_delete_department(
    ...
    delete_response = await async_client.delete(
        Routes.Department.delete.url, params={"id": department_id}
    )
