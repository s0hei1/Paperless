...
class JWT:
    ...
    @classmethod
    async def authorize(cls, token: HTTPAuthorizationCredentials = Depends(_http_bearer),
                  db: ReadOnlyAsyncSession = Depends(get_read_only_db)) -> User:
    ...
    @classmethod
    def create_access_token(self, user_name: str,
